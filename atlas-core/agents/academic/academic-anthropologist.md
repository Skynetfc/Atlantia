...
ruflo_type: atlas-academic-academic-anthropologist
division: academic
state_name: "Archive State"
branch: executive
memory_tier: project-scoped
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: academic/academic-anthropologist.md"
_note: "Edit the source file in academic/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
