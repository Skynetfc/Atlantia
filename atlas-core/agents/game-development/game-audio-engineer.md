...
ruflo_type: atlas-game-development-game-audio-engineer
division: game-development
state_name: "Arcade State"
branch: executive
memory_tier: project-scoped
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: game-development/game-audio-engineer.md"
_note: "Edit the source file in game-development/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
