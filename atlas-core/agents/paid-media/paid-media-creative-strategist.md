...
ruflo_type: atlas-paid-media-paid-media-creative-strategist
division: paid-media
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: paid-media/paid-media-creative-strategist.md"
