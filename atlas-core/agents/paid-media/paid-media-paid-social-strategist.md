...
ruflo_type: atlas-paid-media-paid-media-paid-social-strategist
division: paid-media
state_name: "Signal State (Paid Media)"
branch: executive
memory_tier: project-scoped
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: paid-media/paid-media-paid-social-strategist.md"
_note: "Edit the source file in paid-media/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
