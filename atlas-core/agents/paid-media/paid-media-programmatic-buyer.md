...
ruflo_type: atlas-paid-media-paid-media-programmatic-buyer
division: paid-media
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: paid-media/paid-media-programmatic-buyer.md"
