...
description: Atlantia specialist agent — testing division
ruflo_type: atlas-testing-testing-simulation-sandbox
division: testing
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: testing/testing-simulation-sandbox.md"
_note: "Edit the source file in testing/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
