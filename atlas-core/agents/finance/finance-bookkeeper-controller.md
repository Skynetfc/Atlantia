...
ruflo_type: atlas-finance-finance-bookkeeper-controller
division: finance
state_name: "Ledger State"
branch: executive
memory_tier: ephemeral
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: finance/finance-bookkeeper-controller.md"
_note: "Edit the source file in finance/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
