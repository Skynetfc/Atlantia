...
ruflo_type: atlas-product-product-feedback-synthesizer
division: product
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: product/product-feedback-synthesizer.md"
