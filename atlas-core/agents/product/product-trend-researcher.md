...
ruflo_type: atlas-product-product-trend-researcher
division: product
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: product/product-trend-researcher.md"
