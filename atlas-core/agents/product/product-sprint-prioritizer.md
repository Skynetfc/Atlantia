...
ruflo_type: atlas-product-product-sprint-prioritizer
division: product
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: product/product-sprint-prioritizer.md"
