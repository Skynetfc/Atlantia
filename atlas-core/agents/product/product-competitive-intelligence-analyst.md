...
description: Atlantia specialist agent — product division
ruflo_type: atlas-product-product-competitive-intelligence-analyst
division: product
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: product/product-competitive-intelligence-analyst.md"
_note: "Edit the source file in product/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
