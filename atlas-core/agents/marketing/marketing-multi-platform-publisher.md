...
ruflo_type: atlas-marketing-marketing-multi-platform-publisher
division: marketing
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: marketing/marketing-multi-platform-publisher.md"
