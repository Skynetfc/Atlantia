...
ruflo_type: atlas-marketing-marketing-cross-border-ecommerce
division: marketing
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: marketing/marketing-cross-border-ecommerce.md"
