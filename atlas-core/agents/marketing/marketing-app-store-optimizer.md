...
ruflo_type: atlas-marketing-marketing-app-store-optimizer
division: marketing
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: marketing/marketing-app-store-optimizer.md"
