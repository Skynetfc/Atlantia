...
ruflo_type: atlas-security-security-threat-detection-engineer
division: security
...
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: security/security-threat-detection-engineer.md"
