...
ruflo_type: atlas-security-security-blockchain-security-auditor
division: security
state_name: "Ledger State (Security)"
branch: executive
memory_tier: ephemeral
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: security/security-blockchain-security-auditor.md"
_note: "Edit the source file in security/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
