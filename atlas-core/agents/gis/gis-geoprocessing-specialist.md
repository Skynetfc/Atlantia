...
ruflo_type: atlas-gis-gis-geoprocessing-specialist
division: gis
state_name: "Cartography State"
branch: executive
memory_tier: project-scoped
status: active
model_hint: standard
_source: "Generated by scripts/build-atlas-core.sh from source file: gis/gis-geoprocessing-specialist.md"
_note: "Edit the source file in gis/, then re-run build-atlas-core.sh. Do not edit this file directly."
---
